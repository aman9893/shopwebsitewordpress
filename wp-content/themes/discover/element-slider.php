...
<?php for ($i = 1; $i <= 2; $i++) { ?>
			<li>
			  <a href="<?php echo esc_url(themeszen_get_option('discover_slidelink'.$i)); ?>"><img src="<?php if(esc_url(themeszen_get_option('discover_slideimage'.$i)) != NULL){ echo esc_url(themeszen_get_option('discover_slideimage'.$i));} else echo get_template_directory_uri() . '/images/slide'.$i.'.jpg' ?>" alt="<?php echo esc_html(themeszen_get_option('discover_slideheading'.$i)); ?>" /></a>
