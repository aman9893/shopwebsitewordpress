...
<td>
	...
	<label title='Map'><input type='checkbox' name='order_information[]' value='Order_Map' <?php if(in_array("Order_Map", $Order_Information)) {echo "checked='checked'";} ?> /> <span>Tracking Map</span></label><br />
	<?php
...
<div id='Zendesk' class='otp-option-set otp-hidden'>
<h2 id="zendesk-order-options" class="otp-options-tab-title">Zendesk Options</h2>
<table class="form-table">
<tr>
...
<h2 id="label-order-options" class="otp-options-tab-title">Labelling Options</h2>
		<div class="otp-label-description"> Replace the default text on the status tracking page </div>

<div id='labelling-view-options' class="otp-options-div otp-options-flex">
<div class="otp-styling-header">Status Tracking Form</div>
...
<div class="otp-styling-header">Order Display Page</div>
	...
	<h2 id="styling-order-options" class="otp-options-tab-title">Styling Options</h2>
			<div class="otp-label-description"> Apply custom styling to the status tracking plugin </div>
		...
		<div class='otp-styling-header'>Title - Order Information</div>
			...
			<div class='otp-option otp-field-input'>
				...
				<div class='otp-option-input'><input type='text' class='ewd-otp-spectrum' name='otp_styling_title_font_color' value='<?php echo $OTP_Styling_Title_Font_Color; ?>' /></div>
			</div>
		...
		<div class='otp-styling-header'>Body - Field Labels </div>
			...
			<div class='otp-option otp-field-input'>
				...
				<div class='otp-option-input'><input type='text' class='ewd-otp-spectrum' name='otp_styling_label_font_color' value='<?php echo $OTP_Styling_Label_Font_Color; ?>' /></div>
			</div>
		...
		<div class='otp-styling-header'>Body - Field Content </div>
			...
			<div class='otp-option otp-field-input'>
				...
				<div class='otp-option-input'><input type='text' class='ewd-otp-spectrum' name='otp_styling_content_font_color' value='<?php echo $OTP_Styling_Content_Font_Color; ?>' /></div>
			</div>
		...
		<div class='otp-styling-header'> Buttons </div>
			<div class='otp-option otp-field-input'>
				...
				<div class='otp-option-input'><input type='text' class='ewd-otp-spectrum' name='otp_styling_button_font_color' value='<?php echo $OTP_Styling_Button_Font_Color; ?>' /></div>
			</div>
			<div class='otp-option otp-field-input'>
				<div class='otp-option-label'>Button Background Color</div>
				<div class='otp-option-input'><input type='text' class='ewd-otp-spectrum' name='otp_styling_button_bg_color' value='<?php echo $OTP_Styling_Button_Bg_Color; ?>' /></div>
			</div>
			<div class='otp-option otp-field-input'>
