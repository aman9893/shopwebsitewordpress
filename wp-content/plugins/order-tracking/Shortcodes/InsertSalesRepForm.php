...
function Insert_Sales_Rep_Form($atts) {
	...
	extract( shortcode_atts( array(
		 		'order_form_title' => __('Track your Orders', 'order-tracking'),
				'order_field_text' => __('Sales Rep Number', 'order-tracking'),
				'email_field_text' => __('Sales Rep E-mail', 'order-tracking'),
				'email_field_shortcode' => '',
				'email_field_shortcode_attribute' => '',
				'email_field_attribute_value' => '',
				'order_instructions' => __('Enter your sales rep number in the form below to track your orders.', 'order-tracking'),
				'field_names' => '',
	...
	if (isset($_POST['Sales_Rep_ID'])) {
		...
		$ReturnString .= EWD_OTP_Return_Sales_Rep_Results($_POST['Sales_Rep_ID'], $Fields, isset($_POST['Sales_Rep_Email'])?$_POST['Sales_Rep_Email']:"");
		$ReturnString .= "</div>";
	}
	...
	$ReturnString .= "<input type='text' class='ewd-otp-text-input' name='Sales_Rep_ID' placeholder='" . $order_field_text . "...'>";
	$ReturnString .= "</div>";
	if ($Email_Confirmation == "Order_Email") {
		...
		$ReturnString .= "<input type='email' class='ewd-otp-text-input' name='Sales_Rep_Email' placeholder='" . $email_field_text . "...'>";
		$ReturnString .= "</div>";
	}
