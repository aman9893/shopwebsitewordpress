...
* Description: Create your WordPress shortcode plugin
* Version: 1.0
* Author: Aman Jain
* Author URI: https:webdesky.com
*/
...
<div id="registration_rom">
    ...
    if(isset($_POST['task']) && $_POST['task'] == 'register' ) {
       ...
       // $attachment_id = media_handle_upload('file-upload', $post->ID);
        ...
        if(isset($_FILES['test_upload_image'])){
                $pdf = $_FILES['test_upload_image'];
 
                
                $uploaded=media_handle_upload('test_upload_image', 0);
    ...
    <form method="post" enctype="multipart/form-data">
        ...
        <p><label>uplode file</label></p>
           <input type='file' id='test_upload_pdf' name='test_upload_image'></input>
